...
#todo 23 (fix) +0: handle unexistent config file
...
#todo 31 (doc) +0: config string format: 1. '' - full, 2. 'mysql [host] [log] [pas] [scheme] [table]', (3. 'http [host] [repId] [pass]'), (4. 'breef; ...' for duplication)
        ...
        cfgFound= self.reCfg.match(cfgString)
...
#        elif cfgFound and cfgFound.group(6):
            ...
            self.db= TodoDbFile(self.todoA, uname, _name, cfgPath, cfgString) #throw in sfgString to restore it in file
